...
import { AvailableChartColors, AvailableChartColorsKeys, constructCategoryColors, getColorClassName, getYAxisDomain, hasOnlyOneValueForKey } from "@/lib/chart-utlis"
import { useOnWindowResize } from "@/hooks/use-windowresize"
                    ...
                    activeDot={(props: any) => {
                      ...
                      return (
                        <Dot
                          ...
                          cx={cxCoord}
                          cy={cyCoord}
                          r={5} // Consistent size for active dots
                          fill=""
                          stroke={stroke}
                    ...
                    dot={(props: any) => {
                      ...
                      return (
                        <Dot
                          ...
                          cx={cxCoord}
                          cy={cyCoord}
                          r={0} // Consistent size for all dots
                          stroke={stroke}
                          fill=""
                          strokeLinecap={strokeLinecap}
                          strokeLinejoin={strokeLinejoin}
