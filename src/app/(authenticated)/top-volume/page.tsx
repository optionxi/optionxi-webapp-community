...
import TopVolumeSection from "./topvolume-section";
...
export default function TopGainersPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/top-volume?${newParams.toString()}`, { scroll: false });
  }, [selectedCategory, router]);

  return (
    <ContentLayout title="Top Volume">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
          ...
          <Select
            ...
            >
              <SelectTrigger className="w-[120px]">
                <SelectValue placeholder="Top Volume" />
              </SelectTrigger>
              <SelectContent>
      ...
      <br />
      <TopVolumeSection selectedCategory={selectedCategory} />
    </ContentLayout>
  );
}
