...
export function StockExternalLinks({ stockName }: { stockName: string }){
    const tools = [
        {
          ...
          link: `https://in.tradingview.com/chart/?symbol=${stockName}`,
        },
        {
          title: 'Option Chain',
        ...
        },
        {
          ...
          link:  `https://www.nseindia.com/get-quotes/equity?symbol=${encodeURIComponent(stockName)}`,
        },
        {
          title: 'Market News',
