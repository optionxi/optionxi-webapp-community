...
import { fetchTopLosersData } from '@/lib/supabaseDB/supabase_toplosers';
...
interface TopLosersSectionProps {
  selectedCategory: string;
}

export default function TopLosersSection({ selectedCategory }: TopLosersSectionProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      const { data, error } = await fetchTopLosersData(selectedCategory);
