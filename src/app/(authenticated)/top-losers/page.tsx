...
import TopLosersSection from "./toplosers-section";
...
export default function TopLosersPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/top-losers?${newParams.toString()}`, { scroll: false });
  }, [selectedCategory, router]);

  return (
    <ContentLayout title="Top Losers">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
          ...
          <Select
            ...
            >
              <SelectTrigger className="w-[120px]">
                <SelectValue placeholder="Top Losers" />
              </SelectTrigger>
              <SelectContent>
      ...
      <br />
      <TopLosersSection selectedCategory={selectedCategory} />
    </ContentLayout>
  );
}
